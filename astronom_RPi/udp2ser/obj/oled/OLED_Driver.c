...
static void OLED_InitReg(void)
{
    ...
    OLED_WriteReg(0xA0);//--Set SEG/Column Mapping 0xA0
    OLED_WriteReg(0xC0);//  Set COM/Row Scan Directionv 0xC0
    OLED_WriteReg(0xA6);//--set normal display 0xA6
...
void OLED_flipScreenVertically() {
  OLED_WriteReg(0xA0);              //SEGREMAP   //Rotate screen 180 deg
  OLED_WriteReg(0xA1);
  OLED_WriteReg(0xC0);
  OLED_WriteReg(0xDA);            //COMSCANDEC  Rotate screen 180 Deg
}
